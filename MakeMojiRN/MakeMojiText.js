...
const MakeMojiText = React.createClass({
    propTypes: {
        /**
...
var ReactMojiText = createReactNativeComponentClass(viewConfig);
var RCTVirtualText = ReactMojiText;
